...
public class UpdateProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //back button for finish activity
        ...
        //when image is selected after fetch that image in view
